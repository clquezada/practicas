config_act<- function(file, consulta = NULL){
...
"Merge_and_Cluster_data = F # if set to FALSE, sequences are not merged / clustered",
"Skip_if_complete = F # if the data for a group was completely downloaded + clustered PrimerMiner will not download / cluster the data in the respecitve folder again. Set \"Skip_if_complete\" and \"Download\" to \"F\" if you like all data to be reclustered but not downloaded again",
"",
"# NCBI download, see ?Download_GB for details",
"download_GB = T",
"merge_GB = T",
"maxlength_GB = 2000",
"custom_query_GB = ",consulta,
"clipping_left_GB = 0",
"clipping_rigth_GB = 0",
